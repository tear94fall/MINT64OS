...
.APPLICATIONPROCESSORSTARTPOINT:
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ; 보호 모드로 진입
    ; Disable Paging, Disable Cache, Intrernal FPU, Disable Aligin Check,
    ; Enable ProtectedMode
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    mov eax, 0x4000003B ; PG=0, CD=1, NW=0, AM=0, WP=0, NE=1, ET=1, TS=1, EM=0, MP=1, PE=1
    mov cr0, eax        ; CR0 컨트롤 레지스터에 위에서 지정한 플래그를 설정하여
                        ; 보호 모드로 전환

    ; 커널 코드 세그먼트를 0x00을 기준으로 하는 것으로 교체하고 EIP 의 값을 0x00을 기준으로 재설정
    ; CS 세그먼트 셀렉터 : EIP
...
PRINTMESSAGE:
    ...
    mov ebp, esp        ; 베이스 포인터 레지스터(BP)에 스택 포인터 레지스터(SP)에 값을 설정
...
.MESSAGELOOP:               ; 메시지를 출력하는 루프
    mov cl, byte [ esi ]    ; ESI 레지스터가 가리키는 문자열 위치에서 한 문자를
                            ...
                            ; 문자열 1바이트면 충분하므로 ECX 레지스터의 하위 1바이트만 사용
