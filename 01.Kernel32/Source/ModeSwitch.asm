...
; C 언어에서 호출할 수 있도록 이름을 노출함(Expert)
...
kReadCPUID:
    ...
    push eax        ; 함수에서 입시로 사용하는 레지스터로 함수의 마지막 부분에서
...
kSwitchAndExecute64bitKernel:
    ...
    or eax, 0x620   ; PAE 비트(비트 5)를 와 OSXMMEXCPT 비트(비트 10),
    ...
    mov cr0, eax            ; NW 비트 = 0, CD 비트 = 0, PG 비트 = 1 로 설정한 값을 다시
                            ; CR0 컨트롤 레지스터에 저장
