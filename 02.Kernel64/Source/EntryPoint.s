...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
START:
    mov ax, 0x10    ; IA-32 모드 커널용 데이터 세그먼트 디스크립터를 AX 레지스터에 저장
    ...
    ; 최대 16개 코어까지 지원 가능하므로 스택 영역만 1M를 16으로 나눈 값인
    ...
    mul rbx                 ; RAX 레지스터에 저장된 APIC ID와 RBX 레지스터의 스택 값을 곱합

    sub rsp, rax    ; RSP와 RBP 레지스터에서 RAX 레지스터에 저장된 값(스택의 꼭대기를
    sub rbp, rax    ; 이동시킬 거리)을 빼서 각 코어 별 스택을 할당해줌

    ; 깨어난 Application Processor 수를 1증가 시킴. lock 명령어를 사용하여 변수에
    ; 베타적(Exclusive) 접근이 가능하도록 함
