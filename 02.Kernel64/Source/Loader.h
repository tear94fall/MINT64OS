...
typedef struct
{
    ...
    Elf64_Word e_flags;                 // 프로세서 의존적인 플래그
...
typedef struct
{
    ...
    Elf64_Xword sh_entsize;             // 섹션에 들어 있는 데이터 엔트리의 크기
} Elf64_Shdr;
